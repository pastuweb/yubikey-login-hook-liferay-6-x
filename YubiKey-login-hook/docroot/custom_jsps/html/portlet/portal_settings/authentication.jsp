...
<liferay-util:buffer var="tab">
	<li class="aui-tab aui-state-default" id="<portlet:namespace />tabs1<%= StringUtil.toCharCode("yubikey") %>TabsId">
		<span class="aui-tab-content">
			<a class="aui-tab-label" href="#"><liferay-ui:message key="yubikey" /></a>
		</span>
	</li>
</liferay-util:buffer>

<liferay-util:buffer var="section">
	<div class="aui-helper-hidden" id="<portlet:namespace />tabs1<%= StringUtil.toCharCode("yubikey") %>TabsSection">
		<liferay-util:include page="/html/portlet/portal_settings/authentication/yubikey.jsp" />
	</div>
</liferay-util:buffer>
